...
public class HomePage extends BasePage {
    ...
    @FindBy(id = "Kişi YönetimiH")
    private WebElement contactManagement;
    @FindBy(id = "Kampanya")
    private WebElement campaign;
    @FindBy(id = "Kampanya YönetimiH")
